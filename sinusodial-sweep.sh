...
for repetition in $(seq 3); do
	for proxy_max_age in static-0 static-1 static-10 static-30 dynamic-simplistic dynamic-tbg1 dynamic-adaptive-0.1 dynamic-adaptive-0.25 dynamic-adaptive-0.5 dynamic-updaterisk-0.1 dynamic-updaterisk-0.25 dynamic-updaterisk-0.50 dynamic-updaterisk-0.75 dynamic-updaterisk-0.90; do
		for setter_phase in -3636.4 300 600 1200; do
